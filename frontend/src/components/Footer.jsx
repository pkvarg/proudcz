...
const Footer = () => {
  ...
  const increaseVisitors = async () => {
    try {
      const { data } = await axios.put(
        //`https://proud.pictusweb.site/api/counter/increase`,
  ...
  return (
    <>
      ...
      >
        Tato stránka používá pouze analytické a pro fungování webu nezbytné
        cookies. Nepoužívame funkční ani marketingové soubory cookies.{' '}
        <a
          style={{
            color: '#8a1b1f',
            fontSize: '15px',
