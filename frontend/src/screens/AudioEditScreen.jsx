        ...
        {loading ? (
          ...
          <Form onSubmit={submitHandler}>
            ...
            <Form.Group controlId="audio-file" className="mb-3">
              ...
              <Image className="audio-edit-iframe" src="/images/iframe.webp" alt="iframe" />
              <Form.Control
                type="text"
              ...
              <Form.Group controlId="subcategory" className="my-3">
                ...
                <Dropdown>
                  ...
                  <Dropdown.Menu>
                    ...
                    >
                      <h5 className="language-dropdown-lang">Bůh v listu Římanům</h5>
                    </Dropdown.Item>
                    <Dropdown.Item
                      key="Boží evangelium"
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Boží evangelium</h5>
                    </Dropdown.Item>
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Člověk a dva stromy</h5>
                    </Dropdown.Item>
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Evangelium království</h5>
                    </Dropdown.Item>
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Fakt, víra a prožitek</h5>
                    </Dropdown.Item>
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Hlavní Kristovy kroky</h5>
                    </Dropdown.Item>
                    <Dropdown.Item
                      key="Charakter Pánova pracovníka"
                      value="Charakter Pánova pracovníka"
                      onClick={() => setSubcategory('Charakter Pánova pracovníka')}
                    >
                      <h5 className="language-dropdown-lang"> Charakter Pánova pracovníka</h5>
                    </Dropdown.Item>
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Kristovo vzkříšení</h5>
                    </Dropdown.Item>
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Kristus jako slitovnice </h5>
                    </Dropdown.Item>
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Křesťanský život</h5>
                    </Dropdown.Item>
                    <Dropdown.Item
                      key="Milostivé léto"
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Milostivé léto</h5>
                    </Dropdown.Item>
                    <Dropdown.Item
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Naplnění Starého zákona </h5>
                    </Dropdown.Item>
                    <Dropdown.Item
                      key="Nevystižitelné Kristovo bohatství"
                      value="Nevystižitelné Kristovo bohatství"
                      onClick={() => setSubcategory('Nevystižitelné Kristovo bohatství')}
                    >
                      <h5 className="language-dropdown-lang"> Nevystižitelné Kristovo bohatství</h5>
                    </Dropdown.Item>
                    <Dropdown.Item
                      key="O člověku"
                      value="O člověku"
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Poselství evangelia</h5>
                    </Dropdown.Item>
                    <Dropdown.Item
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Prožívání Krista</h5>
                    </Dropdown.Item>
                    <Dropdown.Item
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Rozdílení života</h5>
                    </Dropdown.Item>
                    <Dropdown.Item
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Řada pro nové věřící</h5>
                    </Dropdown.Item>
                    ...
                    <Dropdown.Item
                      ...
                      onClick={() => setSubcategory('Struktura Božího evangelia')}
                    >
                      <h5 className="language-dropdown-lang"> Struktura Božího evangelia</h5>
                    </Dropdown.Item>
                    <Dropdown.Item
                      key="Svědomí"
                      value="Svědomí"
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Trojnásobné semeno</h5>
                    </Dropdown.Item>
                    <Dropdown.Item
                      key="Učení apoštolů"
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Učení apoštolů</h5>
                    </Dropdown.Item>
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Věčný Boží plán</h5>
                    </Dropdown.Item>
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Vypořádání se s hříchy</h5>
                    </Dropdown.Item>
                    <Dropdown.Item
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Vypořádání se se světem</h5>
                    </Dropdown.Item>
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Vzepřít se Satanovi</h5>
                    </Dropdown.Item>

                    <Dropdown.Item
                      key="Základní prvky křesťanského života"
                      value="Základní prvky křesťanského života"
                      onClick={() => setSubcategory('Základní prvky křesťanského života')}
                    >
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Zjevení života</h5>
                    </Dropdown.Item>

                    <Dropdown.Item
                      key="Zkušenosti věřících s Kristovým vzkříšením"
                      value="Zkušenosti věřících s Kristovým vzkříšením"
                      onClick={() => setSubcategory('Zkušenosti věřících s Kristovým vzkříšením')}
                    >
                      <h5 className="language-dropdown-lang">
                        {' '}
                    ...
                    >
                      <h5 className="language-dropdown-lang"> Zkušenost života</h5>
                    </Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
                <Form.Control
            ...
            <Button className="my-5 btn-blue rounded" type="submit" variant="primary">
              Uložit
            </Button>
          </Form>
        )}
